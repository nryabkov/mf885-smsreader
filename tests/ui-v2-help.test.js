...
test('v2 help covers overview, panel, diagnostics, capability, battery, footer, and actions',()=>{
  ...
  for(const key of ['routerPanel','onlineState','headerNetwork','connection','rsrp','battery','chargeCurrent','device','capabilities','safePreflight','firmwareCanary','firmwareRestore','cellularControl','diagnosticUpdated','refreshStatus','refreshNow','settings','powerAction','resetTraffic']) {
