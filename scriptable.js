...
const WEB_ACTIONS = new Set(["refresh","refreshSms","sendSms","deleteSms","copySms","ussd","detectCapability","detectExperimental","deviceAccess","cellularReconnect","cellularMode","resetTraffic","reboot","powerOff","resumePolling"]);
...
function buildHtml(model) {
  ...
  const hasSmsTotal = Number.isFinite(smsTotal) && smsTotal > 0;
