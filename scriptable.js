...
function buildHtml(model) {
  ...
  <section class="power-toolbar" data-power-control><span>Connection time: <strong data-connection-time>${escapeHtml(connectionTime)}</strong></span><button class="danger" type="button" data-power-action="powerOff">Power off</button><div class="warning" data-power-confirm hidden></div></section>
